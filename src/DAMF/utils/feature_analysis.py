...
def feature_embedding_analysis(source_dataset: MFData,
    ...
    # sample the data
    source_random_idx = random.sample(
        range(0, len(source_dataset)),
        min(1000, len(source_dataset), len(target_dataset)))
    source_dataset = Subset(source_dataset, source_random_idx)
    target_random_idx = random.sample(
        range(0, len(target_dataset)),
        min(1000, len(source_dataset), len(target_dataset)))
